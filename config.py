...
_C.UNSUPERVISED.DATA.CVSM_ROI = 'cheek_n_nose'
...
# -----------------------------------------------------------------------------
# Model Settings for Dual-Stream PhysFormer
# -----------------------------------------------------------------------------
_C.MODEL.DUALSTREAMPHYSFORMER = CN()
_C.MODEL.DUALSTREAMPHYSFORMER.NUM_RGB_CHANNELS = 3
_C.MODEL.DUALSTREAMPHYSFORMER.PATCH_SIZE = 4
_C.MODEL.DUALSTREAMPHYSFORMER.DIM = 96
_C.MODEL.DUALSTREAMPHYSFORMER.FF_DIM = 144
_C.MODEL.DUALSTREAMPHYSFORMER.NUM_HEADS = 4
_C.MODEL.DUALSTREAMPHYSFORMER.NUM_LAYERS = 12
_C.MODEL.DUALSTREAMPHYSFORMER.THETA = 0.7
_C.MODEL.DUALSTREAMPHYSFORMER.RGB_STEM_CHANNELS = [24, 48, 96]  # Default RGB stem channels
_C.MODEL.DUALSTREAMPHYSFORMER.DEPTH_STEM_CHANNELS = [12, 24, 48]  # Default depth stem channels
